...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col w-full max-w-7xl mx-auto px-4 sm:px-6"> {/*container holding the header and main content*/}
        {/* Header */}
        <header className="flex justify-between items-center w-full py-4 bg-gray-75 text-gray-900">
        ...
        {/* Main content */}
        <main className="flex-1 py-6 bg-gray-75 text-gray-900">
          {children}
        </main>
      </div>
    </div>
